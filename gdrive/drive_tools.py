...
async def create_drive_file(
    ...
    Google-native files (mime_type "application/vnd.google-apps.document" /
    ".spreadsheet" / ".presentation") are created empty: omit content, fileUrl and
    base64_content, then populate the returned file ID with the Docs/Sheets/Slides tools.
    ...
    # Google-native types (Docs, Sheets, Slides, folders, ...) may be created
    # empty; Drive does not accept media uploads for these MIME types.
    ...
    # Prefer fileUrl if both legacy sources are provided.
        ...
        # No content source: create an empty Google-native file (metadata only).
        logger.info(
